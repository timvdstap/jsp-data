...
#TODO: Survey data needs updating of 2021 and 2022 data. 
...
fish_lab_data <- read_csv("https://raw.githubusercontent.com/HakaiInstitute/jsp-data/master/supplemental_materials/tidy_data/fish_lab_data.csv", guess_max = 8000)

fish_field_data <- read_csv("https://raw.githubusercontent.com/HakaiInstitute/jsp-data/master/supplemental_materials/tidy_data/fish_field_data.csv", guess_max = 16000)
...
bycatch <- read_csv('https://raw.githubusercontent.com/HakaiInstitute/jsp-data/master/supplemental_materials/tidy_data/bycatch_mort.csv')

sealice <- read_csv("https://raw.githubusercontent.com/HakaiInstitute/jsp-data/master/supplemental_materials/tidy_data/combined_motile_lice.csv")
...
#TODO: Should Krystal & Tim be included in the bibliographic citation..?
...
bycatch_occurrence <- bycatch %>% 
  ...
  filter(scientificName != c("unknown", "Unknown"))
...
#TODO: Determine which YSI reading is from fish capture location, and which from OCGY site - I think we can determine this from the 2019 - 2022 data (event_type or ocgy_lco = fish_capture).
ysi_data <- ysi_data %>%
